'''Fa ̧ca um programa contendo instru ̧c ̃oes para ler do teclado um n ́umero inteiro que representa uma quantidade x de
#segundos. O programa deve imprimir na tela o n ́umero de horas, minutos e segundos contidos em x no formato HH:MM:SS.
#Por exemplo, se x = 5000, ent ̃ao o resultado dever ́a ser 01:23:20, uma vez que 5000 segundos correspondem a 1 hora, 23
